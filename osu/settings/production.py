...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'osu'),
        'USER': os.environ.get('DB_USER', 'osu'),
        'PASSWORD': os.environ.get('DB_PASS', 'osu'),
...
# General
MANAGERS = ADMINS = (
    ('osu Admin', 'osu+admin@izeni.com'),
)

IZENI = {
    'ADMIN': {
        'SITE_TITLE': "osu backend",
    }
}
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'formatter': 'default',
            'filename': '/var/log/osu/django.log',
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'osu', 'templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Static/Media
MEDIA_ROOT = '/var/media/osu/media'
MEDIA_URL = '/media/'
STATIC_ROOT = '/var/media/osu/static'
STATIC_URL = '/static/'
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'osu', 'static'),
)


# URLs
ROOT_URLCONF = 'osu.urls'


# ./manage.py runserver WSGI configuration
WSGI_APPLICATION = 'osu.wsgi.application'
...
# Secrets
SECRET_KEY = '2w@zihzmvaqnf!+4pl$1vh84haepvx62-5wtmuda4ti#2$vw-j'
